...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF009946);
  late Color secondary = const Color(0xFF39D2C0);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFBAB9BD);
  late Color primaryBackground = const Color(0xFF0D0D0D);
  late Color secondaryBackground = const Color(0xFF242424);
  late Color accent1 = const Color(0xFF57615B);
  late Color accent2 = const Color(0xFFE1E8ED);
  late Color accent3 = const Color(0xFFBDBDB9);
