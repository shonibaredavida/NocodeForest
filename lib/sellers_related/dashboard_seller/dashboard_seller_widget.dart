                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Padding(
                                                                                padding: EdgeInsetsDirectional.fromSTEB(10.35, 0.0, 14.35, 0.0),
                                                                                child: InkWell(
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            Padding(
                                                                              padding: EdgeInsetsDirectional.fromSTEB(0.0, 22.5, 0.0, 22.5),
                                                                              child: Text(
                                                                                'Recent Orders',
                                                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                      fontFamily: 'Roboto Condensed',
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            stream:
                                                                                queryOrdersRecord(
                                                                              queryBuilder: (ordersRecord) => ordersRecord.where('seller_id', isEqualTo: currentUserUid),
                                                                            ),
                                                                            builder:
                                                                                (context, snapshot) {
                                                                              // Customize what your widget looks like when it's loading.
                                                                                ...
                                                                                itemBuilder: (context, listViewIndex) {
                                                                                  ...
                                                                                  return StreamBuilder<List<ProductsRecord>>(
                                                                                    stream: queryProductsRecord(
                                                                                      queryBuilder: (productsRecord) => productsRecord.where('product_id', isEqualTo: listViewOrdersRecord.productId),
                                                                                      singleRecord: true,
                                                                                    ),
                                                                                    builder: (context, snapshot) {
                                                                                      ...
                                                                                      final containerProductsRecord = containerProductsRecordList.isNotEmpty ? containerProductsRecordList.first : null;
                                                                                      return Container(
                                                                                        decoration: BoxDecoration(),
                                                                                        child: Visibility(
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      child: StreamBuilder<
                                                                        ...
                                                                        stream:
                                                                            queryProductsRecord(
                                                                          queryBuilder: (productsRecord) => productsRecord.where('sellerInfo', isEqualTo: currentUserReference).orderBy(
                                                                              'num_of_sales',
                                                                              descending: true),
                                                                        ),
                                                                        builder:
                                                                          ...
                                                                          return SingleChildScrollView(
                                                                            ...
                                                                            child:
                                                                                Column(
                                                                              mainAxisSize: MainAxisSize.max,
                                                                              children: List.generate(columnProductsRecordList.length, (columnIndex) {
