...
import 'sidebar_seller_copy_model.dart';
export 'sidebar_seller_copy_model.dart';

class SidebarSellerCopyWidget extends StatefulWidget {
  const SidebarSellerCopyWidget({
    Key? key,
    Color? iconOneColor,
    Color? iconTwoColor,
  ...
  @override
  _SidebarSellerCopyWidgetState createState() =>
      _SidebarSellerCopyWidgetState();
}

class _SidebarSellerCopyWidgetState extends State<SidebarSellerCopyWidget>
    with TickerProviderStateMixin {
  late SidebarSellerCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SidebarSellerCopyModel());
