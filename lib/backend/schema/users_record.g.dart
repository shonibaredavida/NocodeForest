    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'become_a_seller':
          result.becomeASeller = serializers.deserialize(value,
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  bool? _becomeASeller;
  bool? get becomeASeller => _$this._becomeASeller;
  set becomeASeller(bool? becomeASeller) =>
      _$this._becomeASeller = becomeASeller;
