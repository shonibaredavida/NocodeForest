...
import 'landing_page_buyers_copy_model.dart';
export 'landing_page_buyers_copy_model.dart';

class LandingPageBuyersCopyWidget extends StatefulWidget {
  const LandingPageBuyersCopyWidget({Key? key}) : super(key: key);

  @override
  _LandingPageBuyersCopyWidgetState createState() =>
      _LandingPageBuyersCopyWidgetState();
}

class _LandingPageBuyersCopyWidgetState
    extends State<LandingPageBuyersCopyWidget> {
  late LandingPageBuyersCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LandingPageBuyersCopyModel());
                                          ...
                                          child: Container(
                                            ...
                                            child: Padding(
                                              ...
                                              child: FlutterFlowChoiceChips(
                                                options: [
                                                  ChipData('All Categories'),
                                                  ChipData('E-Commerce'),
                                                  ChipData('Fintech App'),
                                                  ChipData(
                                                      'Rental & Real Estate'),
                                                  ChipData('Travel & Tourism'),
                                                  ChipData('Health & Fitness'),
                                                  ChipData('Sport & Gaming'),
                                                  ChipData('News & Blogs'),
                                                  ChipData(
                                                      'Education & Training'),
                                                  ...
                                                  ChipData('Food and Beverage'),
                                                  ChipData('Job & Recruitment'),
                                                  ChipData(
                                                      'Non-profit or charitable'),
                                                  ChipData('Online Gallery')
                                                ],
