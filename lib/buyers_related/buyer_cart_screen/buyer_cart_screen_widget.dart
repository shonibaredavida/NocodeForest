...
class _BuyerCartScreenWidgetState extends State<BuyerCartScreenWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BuyerCartScreenModel());
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 120.0, 0.0, 120.0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
