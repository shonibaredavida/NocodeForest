...
import 'buyer_previous_views_screen_model.dart';
export 'buyer_previous_views_screen_model.dart';

class BuyerPreviousViewsScreenWidget extends StatefulWidget {
  const BuyerPreviousViewsScreenWidget({Key? key}) : super(key: key);

  @override
  _BuyerPreviousViewsScreenWidgetState createState() =>
      _BuyerPreviousViewsScreenWidgetState();
}

class _BuyerPreviousViewsScreenWidgetState
    extends State<BuyerPreviousViewsScreenWidget> {
  late BuyerPreviousViewsScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BuyerPreviousViewsScreenModel());
