...
import 'sidebar_buyer_copy_model.dart';
export 'sidebar_buyer_copy_model.dart';

class SidebarBuyerCopyWidget extends StatefulWidget {
  const SidebarBuyerCopyWidget({
    Key? key,
    Color? iconOneColor,
    Color? iconTwoColor,
  ...
  @override
  _SidebarBuyerCopyWidgetState createState() => _SidebarBuyerCopyWidgetState();
}

class _SidebarBuyerCopyWidgetState extends State<SidebarBuyerCopyWidget>
    with TickerProviderStateMixin {
  late SidebarBuyerCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SidebarBuyerCopyModel());
