...
import 'add_product_copy_n_u_model.dart';
export 'add_product_copy_n_u_model.dart';

class AddProductCopyNUWidget extends StatefulWidget {
  const AddProductCopyNUWidget({Key? key}) : super(key: key);

  @override
  _AddProductCopyNUWidgetState createState() => _AddProductCopyNUWidgetState();
}

class _AddProductCopyNUWidgetState extends State<AddProductCopyNUWidget> {
  late AddProductCopyNUModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddProductCopyNUModel());
                              ...
                              if ((_model.uploadedFileUrl2 != null &&
                                ...
                                await productsRecordReference.set({
                                  ...createProductsRecordData(
                                    name:
                                        _model.productNameFieldController.text,
