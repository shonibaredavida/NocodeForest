...
import 'sidebar_buyer_copy_n_u_model.dart';
export 'sidebar_buyer_copy_n_u_model.dart';

class SidebarBuyerCopyNUWidget extends StatefulWidget {
  const SidebarBuyerCopyNUWidget({
    Key? key,
    Color? iconOneColor,
    Color? iconTwoColor,
  ...
  @override
  _SidebarBuyerCopyNUWidgetState createState() =>
      _SidebarBuyerCopyNUWidgetState();
}

class _SidebarBuyerCopyNUWidgetState extends State<SidebarBuyerCopyNUWidget>
    with TickerProviderStateMixin {
  late SidebarBuyerCopyNUModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SidebarBuyerCopyNUModel());
