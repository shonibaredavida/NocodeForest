...
import 'testing1_model.dart';
export 'testing1_model.dart';

class Testing1Widget extends StatefulWidget {
  const Testing1Widget({Key? key}) : super(key: key);

  @override
  _Testing1WidgetState createState() => _Testing1WidgetState();
}

class _Testing1WidgetState extends State<Testing1Widget> {
  late Testing1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Testing1Model());

    _model.textController1 ??= TextEditingController();
    _model.textField12Controller ??= TextEditingController();
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium,
                                          validator: _model
                                              .textField12ControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                    ),
