...
import 'create_account_modal_copy_n_u_model.dart';
export 'create_account_modal_copy_n_u_model.dart';

class CreateAccountModalCopyNUWidget extends StatefulWidget {
  const CreateAccountModalCopyNUWidget({Key? key}) : super(key: key);

  @override
  _CreateAccountModalCopyNUWidgetState createState() =>
      _CreateAccountModalCopyNUWidgetState();
}

class _CreateAccountModalCopyNUWidgetState
    extends State<CreateAccountModalCopyNUWidget> {
  late CreateAccountModalCopyNUModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAccountModalCopyNUModel());
                                        ...
                                        builder: (context) {
                                          return Padding(
                                            ...
                                            child: DialogComponentWidget(
                                              subtitle:
                                                  'A link has been sent  to ${_model.emailController.text}. Kindly check your inbox or spam to verify your email before you can Login.',
                                              deleteDialog: false,
                                              successDialog: true,
                                              requiresYesNo: false,
                                              nextRoute: () async {},
