...
class FooterComponentWidget extends StatefulWidget {
  const FooterComponentWidget({Key? key}) : super(key: key);

  @override
  _FooterComponentWidgetState createState() => _FooterComponentWidgetState();
}
...
class _FooterComponentWidgetState extends State<FooterComponentWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Padding(
        padding: EdgeInsetsDirectional.fromSTEB(128.5, 96.0, 0.0, 0.0),
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 8.0),
              child: Text(
                '© 2023 Nocode Forest. Trademarks and brands are the property of their respective owners.',
                textAlign: TextAlign.start,
                style: FlutterFlowTheme.of(context).bodyMedium.override(
                      fontFamily: 'Roboto Condensed',
                      color: FlutterFlowTheme.of(context).secondaryText,
