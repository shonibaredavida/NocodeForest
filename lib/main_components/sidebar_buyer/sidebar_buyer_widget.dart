...
import 'sidebar_buyer_model.dart';
export 'sidebar_buyer_model.dart';

class SidebarBuyerWidget extends StatefulWidget {
  const SidebarBuyerWidget({
    Key? key,
    Color? iconOneColor,
    Color? iconTwoColor,
  ...
  @override
  _SidebarBuyerWidgetState createState() => _SidebarBuyerWidgetState();
}

class _SidebarBuyerWidgetState extends State<SidebarBuyerWidget>
    with TickerProviderStateMixin {
  late SidebarBuyerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SidebarBuyerModel());
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(0.0, 8.0, 0.0, 50.0),
              child: InkWell(
            ...
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  ...
                  context.goNamedAuth('landingPageBuyers', mounted);
                },
                child: Container(
                  width: double.infinity,
                  height: 40.0,
