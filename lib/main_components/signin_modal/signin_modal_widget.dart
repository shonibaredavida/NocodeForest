...
import 'signin_modal_model.dart';
export 'signin_modal_model.dart';
                                ...
                                FFButtonWidget(
                                  onPressed: (_model.emailAddressController
                                          ...
                                          (_model.passwordController.text ==
                                              ...
                                              _model.passwordController.text ==
                                                  '') ||
                                          (functions.passwordValidation(_model
                                      ...
                                      : () async {
                                          ...
                                          _model.authReturn =
                                            ...
                                            ' ',
                                            'We dont have your details in our system. Kindly Signup',
                                          );
                                          if (_model.authReturn == null ||
                                              _model.authReturn == '') {
                                            GoRouter.of(context)
                                                .prepareAuthEvent();
